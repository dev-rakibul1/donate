...
const Contribute = () => {
  return (
    <div>
      ...
      <section class="contribute-area section-gap">
        <div class="contribute-box">
          {/* <!-- single box --> */}
          <div class="contribute-single-box">
            <div class="contribute-aricle">
              <div class="sp">
            ...
            <div class="contribute-images"></div>
          </div>

          {/* <!-- single box 2 --> */}
          <div class="contribute-single-box">
            <div class="contribute-imagesTwo"></div>
            <div class="contribute-aricle">
              <div class="sp">
